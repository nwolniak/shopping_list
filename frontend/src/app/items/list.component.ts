...
export class ListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.listService.getAll()
      .subscribe(shoppingListViews => {
        ...
        this.shoppingListViews.forEach(console.log)
      });
  }
  ...
  changePurchaseDate(shoppingList: ShoppingList, event: MatDatepickerInputEvent<Date>) {
    ...
    console.log(utcToZonedTime(event.value!, "Europe/Warsaw"));
    console.log(format(event.value!, "yyyy-MM-dd HH:mm:ssXXX", {timeZone: "Europe/Warsaw"}));
